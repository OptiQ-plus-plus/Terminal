...
echo "==============================================="
echo "Uruchamianie aplikacji StockCharts w Dockerze (tryb WATCHER)"
echo "==============================================="
...
if ! docker compose up --build; then
    ...
    echo "3. Port 4200 lub 5000 jest już zajęty"
    echo ""
    echo "Sprawdzam logi błędów backendu..."
    docker logs stockcharts-backend
    echo ""
    echo "Spróbuj:"
    echo "1. Uruchomić ./clean-docker.sh aby wyczyścić zasoby Docker"
    echo "2. Sprawdzić, czy porty 4200 i 5000 są wolne (komenda: sudo lsof -i :4200,:5000)"
...
echo "Backend Info: http://localhost:5000/api/info"
echo ""
